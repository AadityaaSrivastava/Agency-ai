...
export const Footer = ({theme}) => {
  return (
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20
    sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        {/*Footer Top*/}
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            <div className='text-gray-600 dark:text-gray-400'>
                ...
                <div className='flex gap-2 text-sm'>
                    ...
                    <button className='bg-primary text-white rounded px-6'>Submit</button>
                </div>
            </div>
        </div>
        <hr className='border-gray-300 dark:border-gray-600 my-6'/>
        {/*Footer Bottom*/}
        <div className='pb-6 text-sm text-gray-500 justify-center flex sm:justify-between
        gap-4 flex-wrap'>
