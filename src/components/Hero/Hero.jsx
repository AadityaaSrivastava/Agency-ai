...
export const Hero = () => {
  return (
    ...
    dark:text-white justify-center'>
        ...
        <div className="inline-flex w-fit items-center gap-2 border border-gray-300 p-1.5
        pr-4 rounded-full ">
            <img src={assets.group_profile} alt='' className="w-20"/>
            <p className="text-xs font-small">Trusted by 10K+ people</p>
        </div>

        <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium
        xl:leading-23.75 max-w-5xl" >
            Turning imagination into <span className="bg-linear-to-r
        from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent">digital</span></h1>

        <p className="text-sm sm:text-lg font-medium text-gray-500/75 max-w-4/5
        dark:text-white sm:max-w-lg pb-3">
