...
export const ContactUs = () => {
    ...
    formData.append("access_key", "43bb4576-ebe3-4111-98cc-a0771aeb99bb");
        ...
        <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            <div>
                ...
                dark:border-gray-600'>
                    ...
                    <input name='name' type='text' placeholder='Enter your name' className='
                    w-full p-3 text-sm outline-none' required/>
                </div>
            </div>
            ...
            <div>
                ...
                dark:border-gray-600'>
                    ...
                    <input name='email' type='email' placeholder='Enter your email' className='
                    w-full p-3 text-sm outline-none' required/>
                </div>
            </div>
            ...
            <div className='sm:col-span-2'>
                ...
                <textarea name='message' rows={8} placeholder='Enter your message' className='
