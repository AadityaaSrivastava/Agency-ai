...
function Navbar({ theme, setTheme }) {
  ...
  return (
    ...
    sm:px-12 lg:px-4 xl:px-40 py-4 sticky top-0 z-20
    backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70">
        ...
        <div className={`flex text-gray-700 dark:text-white sm:text-sm
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          hover:scale-103 transition-all"> Connect <img src={assets.arrow_icon} width={14} alt=""/></a>
        </div>
    </div>
  )
}
